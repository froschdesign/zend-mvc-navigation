<?php
/**
 * @see       https://github.com/zendframework/zend-mvc-navigation for the canonical source repository
 * @copyright Copyright (c) 2017 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   https://github.com/zendframework/zend-mvc-navigation/blob/master/LICENSE.md New BSD License
 */

namespace ZendTest\Mvc\Navigation\Page;

use PHPUnit\Framework\TestCase;
use Zend\Mvc\ModuleRouteListener;
use Zend\Mvc\MvcEvent;
use Zend\Mvc\Navigation\Page;
use Zend\Mvc\Navigation\Page\Mvc;
...
use ZendTest\Mvc\Navigation\Page\TestAsset;
...
class MvcTest extends TestCase
{
    ...
    {
        return sprintf('Zend\Router\Http\%s', $type);
    }
    ...
    public function testSetRouteMatchThrowsExceptionOnInvalidParameter()
    {
        ...
        $page = new Page\Mvc();
        $page->setRouter(new TreeRouteStack());
