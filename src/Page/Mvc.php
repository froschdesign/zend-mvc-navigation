...
namespace Zend\Mvc\Navigation\Page;
...
class Mvc extends AbstractPage
{
    ...
    public function setRouteMatch($matches)
    {
        if (! $matches instanceof RouteMatch) {
            throw new Exception\InvalidArgumentException(sprintf(
                'RouteMatch passed to %s must be either a %s instance; received %s',
                __METHOD__,
                RouteMatch::class,
    ...
    public function setRouter($router)
    {
        if (! $router instanceof RouteStackInterface) {
            throw new Exception\InvalidArgumentException(sprintf(
                'Router passed to %s must be either a %s instance; received %s',
                __METHOD__,
